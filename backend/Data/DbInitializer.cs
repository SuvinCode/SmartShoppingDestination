    ...
    public static class DbInitializer
    {
        public static void Initialize(DocketDbContext context)
        {
            ...
            var logs = new[]
            {
                ...
                new SavingLog(demoUser.Id, "Split Shop", 21.60M, 112.30M, DateTime.UtcNow.AddDays(-14)),
                new SavingLog(demoUser.Id, "Woolworths", 14.80M, 92.50M, DateTime.UtcNow.AddDays(-7)),
                new SavingLog(demoUser.Id, "Split Shop", 18.20M, 88.40M, DateTime.UtcNow.AddDays(-1))
            };
